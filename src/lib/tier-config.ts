...
export const TIERS: Record<TierId, TierConfig> = {
  ...
  basic: {
    ...
    features: [
      ...
      { text: "Grade B & C signals (full details)", included: true },
      { text: "AI chat (15 messages/day)", included: true },
      { text: "Daily morning briefing", included: true },
      { text: "S/R levels + Order blocks", included: true },
      { text: "Grade A signals", included: false },
      { text: "Voice assistant", included: false },
      { text: "FVGs, liquidity, supply/demand", included: false },
    ],
  },
  ...
  starter: {
    ...
    features: [
      ...
      { text: "All Grade B & C signals (full details)", included: true },
      { text: "Grade A signals (15-min delayed)", included: true },
      { text: "AI chat (30 messages/day)", included: true },
      { text: "Daily morning briefing", included: true },
      { text: "S/R levels + Order blocks", included: true },
      { text: "AI reasoning on signals", included: true },
      { text: "Voice assistant", included: false },
  ...
  pro: {
    ...
    features: [
      ...
      { text: "ALL signals instant (including Grade A)", included: true },
      ...
      { text: "AI fundamentals + economic calendar", included: true },
      { text: "Signal track record + win rate", included: true },
      { text: "Custom watchlist (5 pairs)", included: true },
      { text: "Priority signal delivery", included: false },
    ],
  },
  ...
  unlimited: {
    ...
    features: [
      ...
      { text: "ALL signals with priority delivery", included: true },
      { text: "Full smart money + AI reasoning", included: true },
      { text: "Unlimited AI chat + voice", included: true },
      { text: "AI fundamentals + economic calendar", included: true },
      { text: "Signal track record + win rate", included: true },
      { text: "Custom watchlist (15 pairs)", included: true },
      { text: "AI trade journal + coaching (coming soon)", included: true },
      { text: "Export signal history", included: true },
